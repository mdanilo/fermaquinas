...
//CUSTOM
function ordernar_por () {
    $('.search-multiple-navigator').append('<fieldset data-name="Ordenacao"><h5>Ordenar por</h5><div><label class="option order" title="Mais Vendidos"><input rel="O=OrderByTopSaleDESC" type="checkbox" name="Mais Vendidos" value="Mais Vendidos"> Mais Vendidos</label> <label class="option order" title="Menor Preço"><input rel="O=OrderByPriceASC" type="checkbox" name="Menor Preço" value="Menor Preço"> Menor Preço</label> <label class="option order" title="Maior Preço"><input rel="O=OrderByPriceDESC" type="checkbox" name="Maior Preço" value="Maior Preço"> Maior Preço</label> <label class="option order" title="Avaliações"><input rel="O=OrderByReviewRateDESC" type="checkbox" name="Avaliações" value="Avaliações"> Avaliações</label> <label class="option order" title="Lançamentos"><input rel="O=OrderByReleaseDateDESC" type="checkbox" name="Lançamentos" value="Lançamentos"> Lançamentos</label> <label class="option order" title="Melhor Desconto"><input rel="O=OrderByBestDiscountDESC" type="checkbox" name="Melhor Desconto" value="Melhor Desconto"> Melhor Desconto</label> <label class="option order" title="A-Z"><input rel="O=OrderByNameASC" type="checkbox" name="A-Z" value="A-Z">A-Z </label> <label class="option order" title="Z-A"><input rel="O=OrderByNameDESC" type="checkbox" name="Z-A" value="Z-A"> Z-A</label> </div></fieldset>');
} ordernar_por();
...
jQuery.fn.vtexSmartResearch = function(opts) {
    ...
    var defaults = {
        ...
        loadContent: ".vitrine .prateleira[id^=ResultItems]", // Elemento que esta em volta da(s) productList(s) de produtos.
        ...
        elemLoading: '<div id="scrollLoading" class="txt-center"><img src="/arquivos/ajax-loader.gif" width="80px" height="80px" /></div>', // Elemento com mensagem de carregando ao iniciar a requisição da página seguinte
    ...
    var fn = {
        ...
        scrollToTop: function() {
            ...
            if (elem.length < 1) {
                elem = jQuery('<div id="returnToTop">' + options.returnTopText + '</div>');
                body.append(elem);
            }
        ...
        infinitScroll: function() {
            ...
            loadContentE.append("<div class='btn-load-more confira-todos-produtos'>Carregar mais itens</div>");
    ...
    var fns = {
        ...
        addFilter: function(input) {
            if ( $('body').width() < 768 ) {
                ...
                prodOverlay.fadeTo(300, 0.6);
                currentSearchUrl = fn.getUrl();
                console.log('Add: '+currentSearchUrl);
                $('.urlLastSearch').text(currentSearchUrl);
                shelfJqxhr = jQuery.ajax({
                    url: currentSearchUrl,
                    success: fns.filterAjaxSuccess,
                    error: fns.filterAjaxError
        ...
        removeFilter: function(input) {
            ...
            console.log('Remove: '+currentSearchUrl);
            $('.urlLastSearch').text(currentSearchUrl);
